    ...
    >
      <div className="flex flex-col items-center gap-4 px-6 py-10 min-h-full">
        ...
        <button
          ...
          className="mt-2 px-8 py-2.5 text-xs uppercase tracking-widest border border-black rounded 
          text-black bg-white hover:bg-black hover:text-white active:scale-95 transition-all"
        >
          PLAY AGAIN
        </button>
