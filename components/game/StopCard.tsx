...
export default function StopCard({ stop, x, y, isDark }: StopCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ position: "absolute", top: "3px", right: "5px", fontSize: "5px", fontWeight: "bold" }}>
          #{stop.order}
        </div>
        <div style={{ fontWeight: "bold", textTransform: "uppercase", letterSpacing: "0.05em", paddingRight: "10px" }}>
          {stop.club}
        </div>
